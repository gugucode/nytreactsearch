...
import { Form, ShowArticles } from './components/home';
import ShowSavedArticles from './components/saved/showSavedArticles'
  ...
  render() {
    return (
      <div className="container">
        ...
        <ShowSavedArticles data={this.state.saveArticles} />
      </div>
    );
  }
}
